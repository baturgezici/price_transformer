...
from transformers import AutoImageProcessor, DeiTForImageClassification, TrainingArguments, Trainer, BeitForImageClassification, SwinForImageClassification, AutoTokenizer, Swinv2ForImageClassification
...
training_args = TrainingArguments(
    output_dir='./results_of_swin2',          # output directory
...
trainer.save_model("./results_of_swin2")
...
# %%
with open(r"C:\Users\Batur\Desktop\CNN-TA\CNN-TA\swinpredictiond.txt", "w") as file:
    file.write(str(b))
    file.write("\n")
