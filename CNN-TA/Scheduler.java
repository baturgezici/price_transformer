...
public class Scheduler {
	...
	// inputFilePathPhase1Training="resources3/CAT20012011.csv";
	...
	public static void main(String[] args) throws Exception {
		...
		if (preferences == 1) {
			...
			for (File f : filesInDirectory) {
				...
				String fileExtenstion = filePathOutputOfPhase1Training.substring(
						filePathOutputOfPhase1Training.lastIndexOf(".") + 1, filePathOutputOfPhase1Training.length());
			...
			for (File f : filesInDirectoryTest) {
				...
				String fileExtenstionTest = filePathOutputOfPhase1Test.substring(
						filePathOutputOfPhase1Test.lastIndexOf(".") + 1, filePathOutputOfPhase1Test.length());
